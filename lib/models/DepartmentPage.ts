...
const DepartmentPageSchema = new Schema<any>(
	{
		header: {
			...
			subtitle2: {
				type: String,
				default: "উন্নত শিক্ষা ও ইসলামিক জ্ঞানের কেন্দ্র",
			},
		},
		intro: {
		...
		cta: {
			...
			description: {
				type: String,
				default: "আমাদের যেকোনো বিভাগে এখনই যোগাযোগ করুন",
			},
...
const DepartmentPage =
	mongoose.models.DepartmentPage ||
	mongoose.model<IDepartmentPage>(
		"DepartmentPage",
		DepartmentPageSchema as any
	);
