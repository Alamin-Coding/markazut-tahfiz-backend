...
const AdmissionPageSchema: Schema<IAdmissionPage> = new Schema(
  {
    header: {
      title: { type: String, default: "ভর্তি তথ্য ও নির্দেশিকা" },
      subtitle: { type: String, default: "মারকাজুত তাহফীজ ইন্সটিটিউশনাল মাদরাসায় স্বাগতম" },
    },
    infoCards: [
      {
        icon: String,
...
const AdmissionPage: Model<IAdmissionPage> =
  mongoose.models.AdmissionPage || mongoose.model<IAdmissionPage>("AdmissionPage", AdmissionPageSchema);
